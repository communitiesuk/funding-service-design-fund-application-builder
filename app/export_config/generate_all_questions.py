...
def print_html(sections: dict, show_field_types=False, show_table_of_content=True, ignore_heading_number=True) -> str:
    ...
    Returns:
        ...
        :param ignore_heading_number:  ignore the heading number
        :param show_table_of_content: ignore table of content
