...
@pytest.mark.parametrize(
    "reset_endpoint",
    [("fund_bp.view_all_funds"), ("round_bp.view_all_rounds")],
)
def test_session_track_visited_pages_reset_session(flask_test_client, seed_dynamic_data, reset_endpoint):
    with flask_test_client.session_transaction():
        ...
        with flask_test_client.session_transaction() as sess:
            ...
            assert sess["visited_pages"][0]["endpoint"] == reset_endpoint
