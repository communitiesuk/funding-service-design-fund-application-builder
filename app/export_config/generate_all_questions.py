...
def print_html(sections: dict, show_field_types=False, allow_table_of_content=True, allow_heading_number=True) -> str:
    ...
    Returns:
        ...
        :param allow_heading_number:  allow the heading number if not need put False
        :param allow_table_of_content: allow the table of content if not need put False
        :param show_field_types: allow the field types if not need put False
    """
    air = Airium()
