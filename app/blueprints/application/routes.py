...
@application_bp.route("/<round_id>/section", methods=["GET", "POST"])
def section(round_id):
    ...
    params["breadcrumb_items"] = [
        ...
        {"text": fund_obj.name_json["en"], "href": url_for("fund_bp.view_fund", fund_id=fund_obj.fund_id)},
        {
            ...
            "href": url_for("application_bp.build_application", fund_id=fund_obj.fund_id, round_id=round_obj.round_id),
        },
...
@application_bp.route("/<round_id>/section/<section_id>/forms", methods=["POST", "GET"])
...
@application_bp.route("/<round_id>/all_questions", methods=["GET"])
...
@application_bp.route("/<round_id>/all_questions/<form_id>", methods=["GET"])
...
@application_bp.route("/<round_id>/create_export_files", methods=["GET"])
