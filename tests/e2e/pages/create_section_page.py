...
class CreateSectionPage(PageBase):
    ...
    def when_add_a_section(self):
        self.section_name = self.fake.word()
        self.metadata.setdefault("sections", []).append(self.section_name)
        self.section_name_txt.fill(self.section_name)
        return self
