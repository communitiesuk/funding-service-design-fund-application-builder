...
def insert_new_form(
    form_name,  # Name as it appears in Apply tasklist
    template_name,  # Our own internal name for the template
    runner_publish_name,  # Unique URL-friendly identifier used in request to Form Runner
    form_json,
):
    form = Form(
        form_id=uuid4(),
...
def update_form(
    ...
    if form:
        ...
        form.runner_publish_name = runner_publish_name
