...
def test_generalized_table_template_with_existing_templates(flask_test_client):
    ...
    assert (
        "This is an placeholder which will be added for the template page" in html
    ...
    assert (
        '<td class="govuk-table__cell">asset-information</td>' in html
    ), "URL path header is not available and table component is missing"
